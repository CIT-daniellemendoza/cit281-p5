# cit281-p5
```
Purpose: Create a Monster Game (working with classes, class constructors, methods, Array map() and forEach())
```

Create and write code for Monster Game functionality. 
...
## p5-monster-game.js starter code
```
